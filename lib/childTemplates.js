...
module.exports = function (reporter, definition) {
  ...
  async function evaluateChildTemplates (reporter, request, response, options) {
    ...
    async function convert (str, p1, offset, s) {
      ...
      if (templateNameIsPath && pathParts.length > 1 && folder == null) {
        // stop the search if we are trying to get asset from a path and any parent folder in it does not exists
